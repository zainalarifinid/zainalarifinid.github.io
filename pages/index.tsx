...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Website Zainal Arifin</title>
        <meta name="description" content="Hi! My name is Zainal Arifin, i am Software Developer from Indonesia" />
        <meta name="keywords" content="zainal arifin, zainal, arifin, zainal arifin software developer" />
        ...
        <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto lg:my-0">
          ...
          >
            <div className="p-4 md:p-12 text-center lg:text-left">
              ...
              <p className="pt-8 text-sm">I would like to Explore something new.</p>

              <div className="pt-12 pb-8">
                <a href="mailto:arifin.1602@gmail.com">
          ...
          <div className="absolute top-0 right-0 h-12 w-18 p-4" onClick={changeTheme}>
