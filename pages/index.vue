    ...
    >
      ...
      >
        <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          <div
            class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center mobile-profile-image"
          ></div>

          <h1 class="text-3xl font-bold pt-8 lg:pt-0">Zainal Arifin</h1>
          <div
          ...
          <p class="pt-8 text-sm">I would like to Explore something new.</p>
      ...
      <!--Img Col-->
      <div class="w-full lg:w-2/5 lg:h-3/5">
      ...
      <div class="absolute top-0 right-0 h-12 w-18 p-4" @click="changeTheme">
